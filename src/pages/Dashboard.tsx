...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"welcome" | "dashboard">("dashboard");
  const { user } = useAuth();
  ...
  const pipelineItems: PipelineItem[] = [
    ...
    { 
      ...
      label: "NOT SCHEDULED", 
      count: notScheduled, 
      percentage: Math.round((notScheduled / total) * 100),
      color: "bg-gray-400",
      showRelease: notScheduled > 0
    },
    { 
      icon: ThumbsUp, 
      label: "WON", 
      count: won, 
      percentage: Math.round((won / total) * 100),
      color: "bg-green-500",
      showRelease: won > 0
    },
  ];
        ...
        {activeTab === "dashboard" ? (
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-lg font-medium text-muted-foreground tracking-wide mb-6">
                    YOUR PIPELINE
                  </h3>
