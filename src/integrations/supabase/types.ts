...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      dial_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "dial_requests_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      list_users: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "list_users_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      sms_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "sms_requests_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_devices: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_devices_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      search_leads_with_access: {
        Args: { _user_id: string; search_term: string }
        Returns: {
          assigned_to: string | null
          call_attempts: number
          callback_scheduled_at: string | null
